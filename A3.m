module top
 (
   ...
   input wire i_ReceivedSignal, //PIN_13
   ...
   output wire PIN_23,
   output wire PIN_24,
   // Whats sent to the Lazer to be transmitted
   output wire o_PRBS,
  );
  ...
  // Change this to set the rate of transmission, e.g 1000000 = 1Mbps.
  parameter BPS = 1000000; // bps
  // parameter PHASE = 16;
  ...
  //assign PIN_13 = w_ReduceCLK;
  assign PIN_13 = r_Shift[9];
...
flipping its state repeatedly, creating a new clock. */
